...
def replay_best_game(replay_file):
    ...
    print(f"\n{'='*60}")
    print(f"  REPLAYING BEST GAME - PPO")
    print(f"{'='*60}")
    print(f"Score: {score}")
    ...
    pygame.display.set_caption(f'PPO - Score: {score}')
    ...
    for i, frame in enumerate(frames):
        ...
        clock.tick(120)  # 120 FPS - adjust for speed
...
if __name__ == '__main__':
    ...
    replay_files = [f for f in os.listdir(results_dir) if f.startswith('ppo_best_replay_')]
